...
- [Отчет о тестировании](Ссылка) со сравнением ручного и автоматизированного тестирования, затраченного времени, найденные проблемы (`Result.md`)
...
- **Меню приложения**
    * *Переход в раздел "Главная" через трехстрочное меню* **(ID 3.1)**
    * *Переход в раздел "Новости" через трехстрочное меню* **(ID 3.2)**
    * *Переход в раздел "О приложении" через трехстрочное меню* **(ID 3.3)**
    * *Переход в раздел тематических цитат "Главное - жить любя" при нажатии на иконку бабочки в меню приложения* **(ID 3.4)**
    * *Выход из учетной записи приложения черз иконку профиля* **(ID 3.5)**
- **Раздел "Главная"**
...
- **Раздел "Панель управления"**
    * *Переход на страницу редактирования новестей "Панель управления" в разделе "Новости"* **(ID 6.1)**
    * *В разделе редактирования новостей "Панель управления" включить сортировку новостей от более старой к более новой новости и от более новой к более старой новости* **(ID 6.2)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по статусу новости только "Не активна"* **(ID 6.3)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по статусу новости только "Активна"* **(ID 6.4)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по статусу новости "Активна" и "Не активна"* **(ID 6.5)**
    * *В разделе редактирования новостей "Панель управления" отсутствие найденный новостей при снятых чекбоксах "Активна" и "Не активна"* **(ID 6.6)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по дате* **(ID 6.7)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "Объявление"* **(ID 6.8)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "День рождения"* **(ID 6.9)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "Зарплата"* **(ID 6.10)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "Профсоюз"* **(ID 6.11)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "Праздник"* **(ID 6.12)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "Массаж"* **(ID 6.13)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "Благодарность"* **(ID 6.14)**
    * *В разделе редактирования новостей "Панель управления" включить фильтр новостей по категории "Нужна помощь"* **(ID 6.15)**
    * *Удаление опубликованной новости на странице редактирования новестей "Панель управления" в разделе "Новости"* **(ID 6.16)**
    * *Отмена удаления опубликованной новости на странице редактирования новестей "Панель управления" в разделе "Новости"* **(ID 6.17)**
    * *Развертывание описания к опубликованной новости на странице редактирования новостей "Панель управления" через нажатие на стрелочку* **(ID 6.18)**
    * *Свертывание описания к опубликованной новости на странице редактирования новостей ""Панель управления" через нажатие на стрелочку* **(ID 6.19)**
    * *Редактирование поля "Категория" у опубликованной новости на странице редактирования новостей "Панель управления"* **(ID 6.20)**
    * *Редактирование поля "Заголовок" у опубликованной новости на странице редактирования новостей "Панель управления"* **(ID 6.21)**
    * *Редактирование поля "Описание" у опубликованной новости на странице редактирования новостей "Панель управления"* **(ID 6.22)**
    * *Редактирование статуса на "Не активна" у опубликованной активной новости на странице редактирования новостей "Панель управления"* **(ID 6.23)**
    * *Редактирование статуса на "Аактивна" у опубликованной не активной новости на странице редактирования новостей "Панель управления"* **(ID 6.24)**
    * *Редактирование поля "Дата публикации" у опубликованной новости на странице редактирования новостей "Панель управления"* **(ID 6.25)**
    * *Редактирование поля "Время" у опубликованной новости на странице редактирования новостей "Панель управления"* **(ID 6.26)**
    * *Переход на страницу "Создание новости" через "Панель управления" в разделе "Новости"* **(ID 6.27)**
